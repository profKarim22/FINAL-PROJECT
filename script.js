...
const rainChars = "01HAPPYBIRTHDAYTOHABIBALOVE";
let rainDrops = [];
let rainFontSize = 18;
...
const heartPhotoFiles = [
  ...
  "photo_26_2026-03-28_23-41-33.jpg",
  ...
  "photo_36_2026-03-28_23-41-33.jpg",
  "photo_37_2026-03-28_23-41-33.jpg",
...
async function runMatrixSequence() {
  ...
  await flashText("HABOBTY", 860, true);
